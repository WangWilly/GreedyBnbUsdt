...
class ActionerS1:
    ...
    """
    def __init__(self, cfg: ActionerS1Config, trader, risk_manager: ManagerAdvancedRisk, exchange: ExchangeClient):
    ...
    async def _execute_s1_adjustment(self, side, amount_bnb):
        ...
        try:
            ...
            if hasattr(self.trader, 'order_manager'):
                 trade_info = {
                     'timestamp': time.time(),
                     'strategy': 'S1', # 标记来源
                     'side': side,
                 ...
                 self.trader.order_manager.add_trade(trade_info)
    ...
    async def check_and_execute(self):
        ...
        try:
            ...
            # 使用风控管理器的仓位计算方法
            position_pct = await self.risk_manager._get_position_ratio()
